...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Simulate successful Google login with @iiitdm.ac.in email
      const mockEmail = 'student@iiitdm.ac.in';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="space-y-6">
            ...
            <div className="text-center">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Institutional Access</h3>
              
              {/* Email Restriction Notice */}
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6">
                <p className="text-sm font-medium text-yellow-800">Email Restriction</p>
              </div>
